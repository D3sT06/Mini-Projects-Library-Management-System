...
import com.sahin.lms.loan_service.swagger.model.BookLoanUpdateRequest;
import com.sahin.lms.loan_service.swagger.model.BookReservationUpdateRequest;
...
public class SwaggerConfig implements BeanFactoryAware {
    ...
    private ApiInfo metaData() {
        ...
        return new ApiInfoBuilder()
                .contact(contact)
                .title("LMS Loan Service")
                .description("Manage loans and reservations")
                .version("1.0")
                .build();
    }
    ...
    private void createBeans() {
        ...
        for (Map.Entry<String,Set<String>> entry : pathsForRoles.entrySet()) {
            ...
            Docket bean = new Docket(DocumentationType.SWAGGER_2)
                    ...
                    .apiInfo(metaData())
                    .pathMapping("/")
                    .additionalModels(typeResolver.resolve(BookLoanUpdateRequest.class), typeResolver.resolve(BookReservationUpdateRequest.class))
